...
const MOCK_DATA = [
  { id: 1, name: "Technology", desc: "Software and IT Services", status: "Active" },
  { id: 2, name: "Healthcare", desc: "Medical and Health", status: "Active" },
];
  ...
  return (
    <div className="flex flex-col h-full bg-[#f8f9fa] w-full animate-fade-in pb-12">
      ...
      <div className="px-6 py-5 shrink-0 flex items-center gap-4">
        ...
        <h1 className="text-xl font-bold text-slate-800">Business Domains</h1>
      </div>
            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50/50">
                  ...
                  <th className="py-4 px-6 text-[13px] font-semibold text-slate-600 whitespace-nowrap">Domain Name</th>
                  <th className="py-4 px-6 text-[13px] font-semibold text-slate-600 whitespace-nowrap">Description</th>
              ...
              <tbody>
                {data.map((item, index) => (
                  <tr key={item.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-3 px-6 text-[13px] text-slate-500">{item.desc}</td>
