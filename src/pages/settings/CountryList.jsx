...
const MOCK_DATA = [
  { id: 1, name: "United States", code: "US", currency: "USD", status: true },
  { id: 2, name: "United Kingdom", code: "UK", currency: "GBP", status: true },
  { id: 3, name: "India", code: "IN", currency: "INR", status: true },
];
  ...
  return (
    <div className="flex flex-col h-full bg-[#f8f9fa] w-full animate-fade-in">
      ...
      <div className="px-6 py-4 shrink-0 flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-slate-800">Country</h1>
      </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-100">
                  ...
                  <th className="py-3 px-4 text-[13px] font-semibold text-slate-600 whitespace-nowrap">Country Name</th>
                  <th className="py-3 px-4 text-[13px] font-semibold text-slate-600 whitespace-nowrap">Code</th>
                  <th className="py-3 px-4 text-[13px] font-semibold text-slate-600 whitespace-nowrap">Currency</th>
              ...
              <tbody>
                {filtered.map((item, index) => (
                  <tr key={item.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-4 px-4 text-[13px] text-slate-600">{item.currency}</td>
