    ...
    <RightDrawer isOpen={isDrawerOpen} onClose={handleClose} title="Add Category">
      <div className="flex flex-col h-full bg-white">
        ...
        <div className="px-6 pt-6 pb-6">
           <label className="block text-[13px] font-medium text-slate-400 mb-2">Category Name</label>
           <input
             type="text"
             value={newCategory}
        ...
        <div className="flex-1 flex flex-col px-6 pb-6">
            <h3 className="text-[15px] font-bold text-slate-800 tracking-tight mb-4">Category List</h3>
                 ...
                 <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="border-b border-slate-100 bg-slate-50/50">
                        ...
                        <th className="py-3 px-4 text-[13px] font-semibold text-slate-700">Category</th>
