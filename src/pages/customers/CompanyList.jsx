            ...
            <table className="w-full text-left border-collapse">
              <thead>
                 <tr className="border-b border-slate-100">
                   ...
                   <th className="py-3 px-4 text-[13px] font-semibold text-slate-600 whitespace-nowrap">Company name</th>
                   ...
                   <th className="py-3 px-4 text-[13px] font-semibold text-slate-600 whitespace-nowrap">registered date</th>
