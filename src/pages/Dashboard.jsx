...
export const Dashboard = () => {
  ...
  const topExpensesData = [
    { name: "Taxes Paid (61%)", value: 200210.0, color: "#3b82f6" },
    { name: "Interest Paid (10%)", value: 200210.0, color: "#f87171" },
    { name: "Utilities (29%)", value: 200210.0, color: "#f59e0b" },
  ];
  ...
  const topTransactionsData = [
    { id: "23426", date: "23/07/2020", amount: 1200.0, type: "in" },
    { id: "23422", date: "19/07/2020", amount: 2500.0, type: "out" },
    { id: "23420", date: "10/07/2020", amount: 7300.0, type: "in" },
    { id: "23417", date: "17/07/2020", amount: 5600.0, type: "in" },
    { id: "23402", date: "18/07/2020", amount: 7300.0, type: "out" },
    { id: "23413", date: "21/07/2020", amount: 8950.0, type: "in" },
    { id: "23412", date: "05/08/2020", amount: 9400.0, type: "out" },
  ];
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#ecfdf5] flex items-center justify-center shrink-0 group-hover:bg-[#d1fae5] transition-colors">
                ...
                >
                  ...
                  />
                  <path
                    d="M3 12C5 8 8 4 12 6C16 8 19 5 21 3"
                    stroke="#10b981"
                    strokeWidth="2"
                    strokeLinecap="round"
                    fill="none"
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#fef2f2] flex items-center justify-center shrink-0 group-hover:bg-[#fee2e2] transition-colors">
                ...
                >
                  ...
                  />
                  <path
                    d="M6 5V3C6 2.45 6.45 2 7 2H15C15.55 2 16 2.45 16 3V5"
                    stroke="#f87171"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center shrink-0 group-hover:bg-gray-200 transition-colors">
                ...
                >
                  ...
                  />
                  <path
                    d="M2 9V13C2 14.66 5.13 16 9 16C12.87 16 16 14.66 16 13V9"
                    stroke="#312e81"
                    strokeWidth="2"
                    fill="none"
                  />
                  <path
                    d="M16 11C19.31 11.28 22 12.56 22 14C22 15.66 18.87 17 15 17"
                    stroke="#312e81"
                    strokeWidth="2"
                    strokeLinecap="round"
                    fill="none"
                  />
                  <path
                    d="M22 14V18C22 19.66 18.87 21 15 21C12.07 21 9.56 20.17 8.5 19"
                    stroke="#312e81"
                    strokeWidth="2"
                    strokeLinecap="round"
                    fill="none"
        ...
        <>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex flex-col mb-8 gap-4">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm font-medium">
                ...
                <span className="text-gray-300">|</span>
                <span className="text-gray-600 border-b-2 border-gray-300 px-1 hover:text-gray-900 cursor-pointer">
                  All
                </span>
              </div>
            </div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center relative min-h-[300px] 2xl:min-h-[450px]">
                <div className="h-[200px] 2xl:h-[300px] w-full relative flex items-center justify-center">
                  ...
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center text-center">
                    ...
                    <span className="text-2xl sm:text-3xl font-bold text-gray-800 mt-1">
                      $4,652.42
                    </span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col h-full items-center text-center">
              <h3 className="text-lg font-semibold text-gray-800 w-full text-left mb-4">
                Expenses
              </h3>
              <div className="flex-1 flex flex-col items-center justify-center relative w-full mt-4 min-h-[250px] 2xl:min-h-[400px]">
                <div className="h-[200px] 2xl:h-[300px] w-full relative flex items-center justify-center">
                  ...
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center">
                    <span className="text-3xl sm:text-4xl font-semibold text-gray-800 tracking-tight">
                      78%
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-8 flex flex-col">
                  <span className="text-2xl sm:text-3xl font-semibold text-gray-800 tracking-tight">
                    82.5k
                  </span>
                  <span className="text-xs text-gray-400 max-w-[140px] mt-1 mx-auto leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col md:flex-row w-full h-full min-w-0">
              ...
              <div className="md:w-[35%] flex flex-col md:border-r border-gray-100 pr-0 md:pr-6 gap-4 sm:gap-5 min-w-0 shrink-0">
                ...
                <div className="flex flex-col mt-auto md:mt-2 min-w-0">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-gray-800 tracking-tight mt-1 truncate">
                    $4,652.42
                  </h3>
              ...
              <div className="md:w-[65%] flex flex-col pl-0 md:pl-6 mt-6 md:mt-0 justify-between gap-3 h-full min-w-0">
                {cashAccountsData.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between border border-gray-100 p-2.5 sm:p-3 rounded-xl bg-white shadow-sm flex-1 min-w-0 gap-2"
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      <div
                        className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 border border-gray-50"
                        style={{
                      ...
                      <span
                        className="text-[12px] sm:text-[13px] font-medium text-gray-600 truncate"
                        title={item.name}
                      >
                        {item.name}
                      </span>
                    </div>
                    <span className="text-[12px] sm:text-[13px] font-bold text-gray-800 whitespace-nowrap pl-1 sm:pl-2 shrink-0">
                      $
              ...
              <div className="md:w-[65%] flex flex-col pl-0 md:pl-6 mt-6 md:mt-0 justify-between gap-3 h-full min-w-0">
                {creditCardsData.map((item, i) => (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      <div
                        className="w-8 h-6 rounded flex items-center justify-center shrink-0 border border-gray-100 shadow-sm"
                        style={{
                          backgroundColor: item.iconBg,
                          color: item.iconCol,
                        }}
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-gray-100">
                      ...
                      <th className="pb-4 text-[13px] font-semibold text-gray-800">
                        Transaction ID
                      </th>
                      <th className="pb-4 text-[13px] font-semibold text-gray-800">
                        Date
                      </th>
                      <th className="pb-4 text-[13px] font-semibold text-gray-800 text-right">
                        Amount
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {topTransactionsData.map((tx, idx) => (
                      ...
                      >
                        ...
                        <td className="py-4 text-[13px] font-medium text-gray-800 text-right">
                          $
        ...
        <div className="flex flex-col gap-6 w-full min-w-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-full min-w-0">
            ...
            <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4">
              ...
              <div className="flex flex-col min-w-0">
                <p className="text-sm font-medium text-gray-500 mb-0.5 truncate">
                  Amount Receivable
                </p>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 w-full min-w-0">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col min-w-0">
              <h3 className="text-[15px] font-bold text-gray-800 mb-6 border-b border-gray-100 pb-4">
                Customer Receivable Balance
              </h3>
              <div className="overflow-x-auto scrollbar-hide">
                <table className="w-full text-left">
                  <thead>
                    <tr className="border-b border-gray-100">
                      <th className="pb-3 text-xs font-semibold text-gray-800 w-[20%]">
                        Transaction ID
                      </th>
                      <th className="pb-3 text-xs font-semibold text-gray-800 w-[35%]">
                        Customer name
                      </th>
                      <th className="pb-3 text-xs font-semibold text-gray-800 w-[25%] text-center">
                        Date
                      </th>
                      <th className="pb-3 text-xs font-semibold text-gray-800 w-[20%] text-right pr-2">
                        Amount
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {customerReceivableData.map((row, idx) => (
                      <tr
                        ...
                        className="border-b border-gray-50 last:border-0 hover:bg-gray-50/50 transition-colors"
                      >
                        <td className="py-4 text-xs font-medium text-gray-600 truncate">
                          {row.txId}
                        </td>
                        <td className="py-4 text-[13px] font-medium text-gray-600 truncate">
                          {row.name}
                        </td>
                        <td className="py-4 text-xs font-medium text-gray-500 text-center truncate">
                          {row.date}
                        </td>
                        <td className="py-4 text-[13px] font-medium text-gray-800 text-right pr-2">
                          $
